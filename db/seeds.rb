...
puts '🌱 Creating events...'
  ...
  event1 = Event.new(
    ...
    event_date: DateTime.new(2020, 05, 15, 18, [0, 30].sample, 0),
  ...
  event2 = Event.new(
    ...
    event_date: DateTime.new(2020, 04, 07, 18, [0, 30].sample, 0),
  ...
  event3 = Event.new(
    ...
    event_date: DateTime.new(2020, 05, 10, 19, [0, 30].sample, 0),
  ...
  event4 = Event.new(
    ...
    event_date: DateTime.new(2020, 05, 02, 19, [0, 30].sample, 0),
...
event5 = Event.new(
    ...
    event_date: DateTime.new(2020, 04, 18, 18, [0, 30].sample, 0),
  ...
  event6 = Event.new(
    ...
    event_date: DateTime.new(2020, 04, 06, 19, [0, 30].sample, 0),
  ...
  event7 = Event.new(
    ...
    event_date: DateTime.new(2020, 04, 24, 18, [0, 30].sample, 0),
    description: "Enjoy a 3-course meal which includes a fish dish, a meat dish, and, of course, dessert—this course is not suitable for vegans or vegetarians. Talk about cooking techniques and delicious meals made out of fresh ingredients. Enjoy wine and olive oils while communicating about the history of Portuguese cuisine. Sit down and break bread with your fellow foodies. Leave the course with the knowledge to prepare the meal at home and a belly full of food and memories.",
    cuisine: 'German',
    max_guests: 10,
    booked_guests: 3,
  ...
  event8 = Event.new(
    ...
    event_date: DateTime.new(2020, 05, 12, 18, [0, 30].sample, 0),
    description: "Enjoy a 3-course meal which includes a fish dish, a meat dish, and, of course, dessert—this course is not suitable for vegans or vegetarians. Talk about cooking techniques and delicious meals made out of fresh ingredients. Enjoy wine and olive oils while communicating about the history of Portuguese cuisine. Sit down and break bread with your fellow foodies. Leave the course with the knowledge to prepare the meal at home and a belly full of food and memories.",
    cuisine: 'Mexican',
    max_guests: 10,
    booked_guests: 0,
  ...
  event9 = Event.new(
    ...
    event_date: DateTime.new(2020, 04, 19, 18, [0, 30].sample, 0),
